...
For a detailed description of the methodology, analyses, and complete results, see the full project report in Spanish: [`report/LewyBody_Project_ES.pdf`](report/LewyBody_Project_ES.pdf).
